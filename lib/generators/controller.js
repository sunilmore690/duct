/**
  ...
  *
  * Ex:
  * duct g/generate controller Post/post
  *
  * This would create a controller inside api/controllers/ whose name would be pluralized despite of 
  * what form you give.
  *
  * api/controllers/posts_controller.js
  */
...
ControllerGenerator.prototype = {
  ...
  generate: function() {
    ...
    /**
      * Create the api/ folder and then the /api/controller/ folder 
      */
  ...
  /**
    * Creates the controller folder inside api
    */
  createControllerFolder: function () {
    if ( !fs.existsSync( this.apiPath() + '/controllers' ) ) {
      fs.mkdirSync( this.apiPath() + '/controllers');
    };
  },
  ...
  controllerDestination: function () {
    return root + '/api/controllers/' + inflect.decapitalize( this.pluralizedName ) + '_controller.js';
  }
};
