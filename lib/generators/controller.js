...
ControllerGenerator.prototype.generate = function() {
  ...
  if ( fs.existsSync( this.controllerDestination() ) ) {
    ...
    /**
      ...
      */
    fs.writeFile( this.controllerDestination() , compiledHBStemplate( { name: this.pluralizedName } ), 'utf8', function(err) {
      if (err) throw err;
...
/**
  ...
  */
ControllerGenerator.prototype.controllerName = function () {
...
/**
  ...
  */
ControllerGenerator.prototype.formattedControllerName = function () {
...
/**
  ...
  */
ControllerGenerator.prototype.controllerDestination = function () {
